                ...
                <div className="detail-card">
                    ...
                    <div className="section-content">
                        ...
                        <div style={{ marginTop: "15px" }}>
                                <button className="update-btn" onClick={() => navigate(`/sales-order/detail/${data.id}`)}>
                    ...
                    <div className="detail-card">
                        ...
                        <div className="section-content">
                            ...
                            <div className="detail-row">
                                ...
                                <span className="detail-value">Rp{parseFloat(data.invoice.remainingAmount).toLocaleString("id-ID", { minimumFractionDigits: 2 })}</span>
                            </div>

                            <div style={{ marginTop: "15px" }}>
                                <button className="update-btn" onClick={() => navigate(`/sales-invoice/detail/${data.id}`)}>
                                    Lihat Detail Faktur
                                </button>
                            </div>
                        </div>
                ...
                {data.shipping && (
                    <div className="detail-card">
                        ...
                        <div className="section-content">
                            ...
                            <div style={{ marginTop: "15px" }}>
                                <button className="update-btn" onClick={() => navigate(`/shipping/detail/${data.id}`)}>
                    ...
                    <div className="detail-card">
                        ...
                        <div className="section-content">
                            ...
                            <div className="detail-row">
                                ...
                                <span className="detail-value">Rp{parseFloat(data.payment.totalAmountPayed).toLocaleString("id-ID", { minimumFractionDigits: 2 })}</span>
                            </div>
                        </div>
                    </div>
                )}
                    ...
                    <div className="detail-card">
                        ...
                        <div className="section-content">
                            ...
                            <div className="detail-row">
                                ...
                                <span className="detail-value">Rp{parseFloat(data.receipt.amountPayed).toLocaleString("id-ID", { minimumFractionDigits: 2 })}</span>
                            </div>

                            <div style={{ marginTop: "15px" }}>
                                <button className="update-btn" onClick={() => navigate(`/sales-receipt/detail/${data.id}`)}>
                                    Lihat Detail Nota
                                </button>
                            </div>
                        </div>
