...
const ConfirmSalesOrder = () => {
    ...
    const [modalType, setModalType] = useState(null); // "confirm" or "cancel"
        ...
        <div className="gudang-form-container">
            <div className="gudang-form-content">
                ...
                <div className="form-actions">
                    ...
                    <button className="submit-btn" onClick={() => setModalType("confirm")}>Konfirmasi</button>
                </div>
