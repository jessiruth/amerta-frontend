...
const SalesReceiptDetail = () => {
    ...
    const handleBack = () => navigate("/sales-receipt");
            ...
            <div className="gudang-detail-content">
                ...
                <div className="detail-card">
                    ...
                    <div className="section-content">
                        ...
                        <div className="detail-row"><span className="detail-label">Jumlah Diterima:</span><span className="detail-value">Rp {parseFloat(data.receipt.amountPayed).toLocaleString("id-ID")}</span></div>
                    </div>
                </div>
