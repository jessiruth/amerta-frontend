...
const DeliverPurchaseOrder = () => {
    ...
    const validateInputs = async () => {
        ...
        if (new Date(deliveryDate) < new Date(data.purchaseDate)) {
            errors.deliveryDate = "Tanggal pengiriman tidak boleh sebelum tanggal purchase order.";
        }
        if (data.invoice?.invoiceDate && new Date(deliveryDate) < new Date(data.invoice.invoiceDate)) {
        ...
        <div className="gudang-form-container">
            <div className="gudang-form-content">
                <div className="page-header">
                    <h1 className="page-title">Delivery Purchase Order</h1>
                </div>
                ...
                <div className="detail-card">
                    ...
                    <div className="section-content">
                        ...
                        <div className="detail-row"><span className="detail-label">Vendor:</span><span className="detail-value">{customerName}</span></div>
                ...
                <div className="form-actions">
                    {data.status === "CONFIRMED" ? (
                        ...
                        <button className="cancel-btn" onClick={() => navigate("/delivery")}>Kembali</button>
                    )}
                </div>
...
export default DeliverPurchaseOrder;